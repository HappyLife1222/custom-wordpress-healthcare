...
if ( ! class_exists( 'Medical_Healthcare_Elementor_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Medical_Healthcare_Elementor_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Medical_Healthcare_Elementor_WPTT_WebFont_Loader( $url );
